<template>
<div>
<!--    <el-form ref="form" :model="wasteInfo" label-width="100px" size="mini" style="margin-top: 20px">
        <el-form-item label="项目名称">
            <el-input v-model="wasteInfo.name" placeholder="例：xx科技有限公司1000万吨/年的炼油化工一体项目"></el-input>
        </el-form-item>

        <el-form-item label="装置类别" style="text-align:left">
            <el-select v-model="wasteInfo.system_id" filterable allow-create>
        ...
        <el-form-item label="装置性质" style="text-align:left">
            <el-radio-group v-model="wasteInfo.tower_name">
        ...
        <el-form-item label="设计完成时间">
            <el-col :span="11">
                <el-date-picker type="date" placeholder="选择日期" v-model="wasteInfo.unit" style="width: 100%;"></el-date-picker>
            </el-col>
        </el-form-item>
